...
public enum ErrorCode {
	...
	INVALID_PHONE_NUMBER(1008, "Phone number must start with +84 or 0 and followed by 9 digits",
	...
	INVALID_ACCOUNT_NAME(1029, "Account name can not contain numbers or special characters",
			HttpStatus.BAD_REQUEST),
	...
	BANK_ACCOUNT_ALREADY_LINKED_TO_PROFILE(1035, "Bank account is already linked to profile",
			HttpStatus.BAD_REQUEST),
