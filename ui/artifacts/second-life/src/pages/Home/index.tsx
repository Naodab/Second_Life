          ...
          <div className="flex overflow-x-auto hide-scrollbar gap-4 pb-4 -mx-4 px-4 sm:mx-0 sm:px-0">
            {CATEGORIES.map((cat, i) => (
              <Link key={i} href={`/search?category=${cat}`}>
                <div className="flex-none bg-card border rounded-2xl p-6 text-center min-w-[140px] cursor-pointer hover:border-primary hover:shadow-md transition-all hover:-translate-y-1">
                  <div className="w-12 h-12 mx-auto bg-primary/10 rounded-full flex items-center justify-center mb-3">
                    <span className="text-primary font-bold text-xl">{cat.charAt(0)}</span>
                  </div>
